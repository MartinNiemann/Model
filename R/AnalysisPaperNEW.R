...
test.df <- log1p(stocks.idret.kurt5.df)
...
legend("topleft", legend=c("mean", "1Y-CMA(mean)", "1Y-CMA(5/95%ile)",
       ...
       col=c("grey50", "black", "grey50", "black"))
...
ConstructPanel <- function (off=T) {  
  ...
  # HFLL - HFT flags / 1M share volume
...
plot(tapply(stocks.panel.sub$QCH, stocks.panel.sub$date, mean))

check.res <- felm((HFLVlog)~(QCH)+(VOLE)+(SIZE)+(PR)+(TOV)+G(date)+G(symbol), 
                  stocks.panel.sub, clustervar=interaction(stocks.panel.sub$symbol, 
...
check.res <- felm((HFLVlog)~(SSB)+(VOLE)+(SIZE)+(PR)+(TOV)+G(date)+G(symbol), 
...
check.res2 <- felm(HFLVlog~(VOLE)+SIZE+(PR)+(TOV)+G(date)+G(symbol), 
                  stocks.panel.pdf, clustervar=interaction(stocks.panel.pdf$symbol, 
                                                           stocks.panel.pdf$date))
summary(check.res2)
...
Reg1stStage(stocks.panel.pdf, formula(HFL~NMS+G(date)+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(HFLlog~NMS+G(date)+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(HFLVlog~NMS+G(date)+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(HFLLlog~NMS+G(date)+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(HPQVlog~NMS+G(date)+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(HPQLlog~NMS+G(date)+G(symbol)), classes.size3, T, F)
# --> NMS: Focus on HFLV
...
Reg1stStage(stocks.panel.pdf, formula(sqrt(VOLE)~NMS+G(date)+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula((VOLE)~NMS+G(date)+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(log(TOV)~NMS+G(date)+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula((TOV)~NMS+G(date)+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(SIZE~NMS+G(date)+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(PR~NMS+G(date)+G(symbol)), classes.size3, T, F)

# 4.3c) Check instrument vs. Dependent EEU/EED
Reg1stStage(stocks.panel.pdf, formula(sqrt(EEU)~NMS+G(date)+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(sqrt(EED)~NMS+G(date)+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(sqrt(EEU+EED)~NMS+G(date)+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(sqrt(EEU)~NMS+(VOLE)+PR+SIZE+log(TOV)+G(date)+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(sqrt(EED)~NMS+(VOLE)+PR+SIZE+log(TOV)+G(date)+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(sqrt(EEU+EED)~NMS+VOLE+PR+SIZE+log(TOV)+G(date)+G(symbol)), classes.size3, T, F)

Reg1stStage(stocks.panel.pdf, formula(BETA~NMS+G(date)+G(symbol)), classes.size3, T)
Reg1stStage(stocks.panel.pdf, formula(VOLA~NMS+G(date)+G(symbol)), classes.size3, T)
Reg1stStage(stocks.panel.pdf, formula(LIQ~NMS+G(date)+G(symbol)), classes.size3)
Reg1stStage(stocks.panel.pdf, formula(log(VOL)~NMS+G(date)+G(symbol)), classes.size3)
Reg1stStage(stocks.panel.pdf, formula(FLT~NMS+G(date)+G(symbol)), classes.size3)

hist(log(stocks.panel.pdf$IRK))
...
# stocks.panel.pdf$TOVU15 <- 0.0001*exp(stocks.panel.pdf$TOVU15)
# stocks.panel.pdf$TOVD15 <- 0.0001*exp(stocks.panel.pdf$TOVD15)
...
nrow(stocks.panel.pdf)
length(levels(stocks.panel.pdf$date))
length(levels(stocks.panel.pdf$symbol))

# 4.6f) Intraday Tail Index ----------------------------------------------------
summary(stocks.panel.pdf$IRT)
stocks.panel.pdf$IRT[is.na(stocks.panel.pdf$IRT)] <- .4
summary(stocks.panel.pdf$IRT5)
stocks.panel.pdf$IRT5[is.na(stocks.panel.pdf$IRT5)] <- .37
summary(stocks.panel.pdf$IRT15)
stocks.panel.pdf$IRT15[is.na(stocks.panel.pdf$IRT15)] <- .35
summary(stocks.panel.pdf$IET)
stocks.panel.pdf$IET[is.na(stocks.panel.pdf$IET)] <- .4
...
tapply(stocks.panel.pdf$HFL, interaction(classes.size3),
       FUN=sd)
Summarize2(stocks.panel.pdf$HFLV)
tapply(stocks.panel.pdf$HFLV, interaction(classes.size3),
       FUN=mean)
tapply(stocks.panel.pdf$HFLV, interaction(classes.size3),
       FUN=median)
tapply(stocks.panel.pdf$HFLV, interaction(classes.size3),
       FUN=sd)
Summarize2(stocks.panel.pdf$HFLL)
tapply(stocks.panel.pdf$HFLL, interaction(classes.size3),
       FUN=mean)
tapply(stocks.panel.pdf$HFLL, interaction(classes.size3),
       FUN=median)
tapply(stocks.panel.pdf$HFLL, interaction(classes.size3),
       FUN=sd)
Summarize2(stocks.panel.pdf$HFLVU15)
tapply(stocks.panel.pdf$HFLVU15, interaction(classes.size3),
       FUN=mean)
tapply(stocks.panel.pdf$HFLVU15, interaction(classes.size3),
       FUN=median)
tapply(stocks.panel.pdf$HFLVU15, interaction(classes.size3),
       FUN=sd)
Summarize2(stocks.panel.pdf$HFLVD15)
tapply(stocks.panel.pdf$HFLVD15, interaction(classes.size3),
       FUN=mean)
tapply(stocks.panel.pdf$HFLVD15, interaction(classes.size3),
       FUN=median)
tapply(stocks.panel.pdf$HFLVD15, interaction(classes.size3),
...
# 4.9b) EE scores
Summarize2(stocks.panel.pdf$EEU+stocks.panel.pdf$EED)
tapply(stocks.panel.pdf$EEU+stocks.panel.pdf$EED, interaction(classes.size3),
       FUN=mean)
tapply(stocks.panel.pdf$EEU+stocks.panel.pdf$EED, interaction(classes.size3),
       FUN=median)
tapply(stocks.panel.pdf$EEU+stocks.panel.pdf$EED, interaction(classes.size3),
       FUN=sd)
Summarize2(stocks.panel.pdf$EEU)
tapply(stocks.panel.pdf$EEU, interaction(classes.size3),
       FUN=mean)
tapply(stocks.panel.pdf$EEU, interaction(classes.size3),
       FUN=median)
tapply(stocks.panel.pdf$EEU, interaction(classes.size3),
       FUN=sd)
Summarize2(stocks.panel.pdf$EED)
tapply(stocks.panel.pdf$EED, interaction(classes.size3),
       FUN=mean)
tapply(stocks.panel.pdf$EED, interaction(classes.size3),
       FUN=median)
tapply(stocks.panel.pdf$EED, interaction(classes.size3),
...
# 4.9c) Controls
Summarize2(stocks.panel.pdf$VOLE)
tapply(stocks.panel.pdf$VOLE, interaction(classes.size3),
       FUN=mean)
tapply(stocks.panel.pdf$VOLE, interaction(classes.size3),
       FUN=median)
tapply(stocks.panel.pdf$VOLE, interaction(classes.size3),
       FUN=sd)
Summarize2(1/stocks.panel.pdf$PR)
tapply(1/stocks.panel.pdf$PR, interaction(classes.size3),
       FUN=mean)
tapply(1/stocks.panel.pdf$PR, interaction(classes.size3),
       FUN=median)
tapply(1/stocks.panel.pdf$PR, interaction(classes.size3),
       FUN=sd)
Summarize2(exp(stocks.panel.pdf$SIZE))
tapply(exp(stocks.panel.pdf$SIZE), interaction(classes.size3),
       FUN=mean)
tapply(exp(stocks.panel.pdf$SIZE), interaction(classes.size3),
       FUN=median)
tapply(exp(stocks.panel.pdf$SIZE), interaction(classes.size3),
       FUN=sd)
tapply(stocks.panel.pdf$TOV, interaction(classes.size3),
       FUN=mean)
tapply(stocks.panel.pdf$TOV, interaction(classes.size3),
       FUN=median)
tapply(stocks.panel.pdf$TOV, interaction(classes.size3),
