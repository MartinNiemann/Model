...
Reg1stStage(stocks.panel.pdf, formula(HFL~NAB+TREND+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(HFLlog~NAB+TREND+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(HFLVlog~NAB+TREND+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(HFLLlog~NAB+TREND+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(HPQVlog~NAB+TREND+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(HPQLlog~NAB+TREND+G(symbol)), classes.size3, T, F)
# --> NAB: Focus on HFLV
...
Reg1stStage(stocks.panel.pdf, formula(sqrt(VOLE)~NAB+TREND+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula((VOLE)~NAB+TREND+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(log(TOV)~NAB+TREND+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula((TOV)~NAB+TREND+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(SIZE~NAB+TREND+G(symbol)), classes.size3, T, F)
Reg1stStage(stocks.panel.pdf, formula(PR~NAB+TREND+G(symbol)), classes.size3, T, F)
